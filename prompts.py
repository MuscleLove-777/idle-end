...
BLOG_PERSONA = '心理カウンセラー資格を持つ元廃人で、放置ゲーム引退と人生再構築を経験したライター'
TONE_GUIDANCE = '- 「やめろ」と説教せず、共感ベースで段階的に\n- メンタル面は心理学的根拠を示しつつ、医療相談を推奨\n- 乗り換え先は「もっと軽い放置」「全く別ジャンル」など複数提示\n- 「絶対やめられる」など断定は避ける\n- 末尾に「卒業準備度チェックリスト」を入れる'
